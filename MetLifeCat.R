...
snackpattern <- 'Ruffles|Strips|Cheez It|Caprese|Nacos|Hummus|Funyuns|Mints|Tot|Nestle|Sticks|Egg Rolls|Cheese|Tots|[Tt]oast|[Bb]un|[Dd]ough|[Dd]ulce|[Rr]ose|[Nn]utella|Bar|Baked OriginalNacos|Bacon|Yummies|Protein Bar|Snack|Oreo|Flipz|[Nn]acho|Muffin|[Cc]hip|CHIP|[Pp]eanuts|COOKIES|[Pp]opcorn|Pretzel|Dorito|[Cc]heetos|Cheez-it|Ming\'s Bings|Gourmet Nut Mix'
...
entreepattern <- 'Meal|Kosher|Vegan|Sliders|Mezze|Pie|Steak|Rice and Beans|Potatoes|Pineapple|Cranberry|Shark|Turkey|Edamame|Deli|Roll|Califlower|Pies|Salad|Tender|Shishito|[Pp]anini|[Ff][Oo][Oo][Dd]|Appetizer Special|Spring Roll|[Nn]oodle|[Bb]uffet|Shrimp Skewer|Royal Red Shrimp Scampi|[Ff]luffernutter|[Pp]ortobello|[Pp]uttanesca|[Aa]ffogato|[Mm]elt|[Mm]ELT|[Bb]jurger|Huevos Rancheros|Eggs|Ribs|Meatloaf|Cheese|Nashville Tender|[Ee]ntree|Brookie|APPETIZER|Starter|Burrata|Pancake|Wrap|Kid|BURGER|Sandwhich|Lofts|Rafters|Meatball|[Ss][Aa][Nn][Dd][Ww][Ii][Cc][Hh]|Patty Melt|[cC]alamari|[Ss]ub|Hoagie|Salad|Mac & Cheese|Mac and Cheese|[Cc]hicken|[Pp]ork|[Bb]risket|[Gg]rilled|[Tt]aco|BBQ|[Bb]urger|Reuben|[Ww]ing|[Bb]urrito|Hog|[Ff]latbread|[Cc]lub|[Bb]oneless|Firecracker Shrimp|Roast|Boardroom Food|[Tt]una|[Pp]asta|Atlantic Cod|[Cc]obb|[Ss]alm|[qQ]uesadilla|[dD]umpling|[Bb]eef|[oO]ysters|Hummus Platter|[sS]ushi|[cC]rudite|[oO]melet|STEAK|[cC]hurro|[Ff]ish|FISH|[Ll]amb|[lL]asagna|[lL]obster|York Street Veggie Tray|Jalapeno Poppers'
dogpattern <- '[Dd]og|[Ss]ausage|[Bb]ratwurst|DOG|Kk]osher'
sidepattern <- 'Veggie|Dip|Jerky|Side|Biscuit|Bagel|Fruit|[Cc]repe|[Ff]rench [Ff]ry|[Ff]ries|Cheese Sticks|Spinach Dip|[Ss]oup|Mashed Potato|[Cc]howder|Lemon Wedges|[Ww]edges|Salsa Trio|Thai Brussels|side of cheese'
dessertpattern <- 'Creme Brule|Big Alaska|Dot Cup|Dibs|[Cc]repe|[Cc]risp|[Tt]art|[Dd][Ee][Ss][Ss][Ee][Rr][Tt]|Tiramisu|CC|Danish|Ice Cream|Cone|Dots|Brownie|Miss Vickie|Cookie|[Cc]ake|Creme Brulee|[gG]elato|[dD]essert|Chocolate Strawberries|[Ss]coop'
addonpattern <- 'X Cheese|Add Queso|Add on|Add Bacon|Add Chili|add ice cream|Beverage Package Add On|Add Guacamole|Add Shrimp|[Ss]ide of [Cc]heese'
...
sodapattern <- '[Ss][Oo][Dd][Aa]|[Cc]oke|[Ss]prite|Mist|[Cc]oke|[Ss]prite|Shirley|Athletic|BEO SODA|N/A Beverage Package ED|Fanta|[Mm]ellow|[Ll]emonade|Minute Maid|Punch|Icee|ICEE|Frozen|[Ff]ountain|[Mm]ountain Dew'
energypattern <- '[Mm]onster|[Ee]nergy|Athletic|[Pp]owerade|[Dd]rink|[Pp]owerad|Cintron|Mule'
...
chipspattern<- 'Ruffles|Cheez-it|Nacos|Tot|Nacho|Nachos|Funyuns|[Cc]hip|CHIP|Baked OriginalNacos|[Cc]heetos|Dorito|[Ll]ays|BBQ|Dips'
...
craftpattern <- '[Ii]PA|[Aa]le|[Ll]ager|Blue Moon|Rita|Heineken|Sierra Nevada|Shiner Bock|Fat Tire|Amstel|Sam Adam|Yeehaw|Large Goose Island|Blood Orange Wheat|Jacks Abby|Jack\'s Abby'
domesticpattern <- 'Domestic|PBR|Bud|Miller|Coors|Michelob|Mich|Yuengling|Rolling Rock|Busch'
seltzerpattern <- 'Truly|SPIKED|Spiked|Smirnoff|White Claw|[sS]eltzer|Smirnoff'
winepattern <- 'Wine|Cabernet|Miraval|Babe Red|Uncorked|Simi|Will Hill|Dusse|Marg|Chard|Shiraz|Blend|Sauv|Pinot|Prosecco|Rose|Riesling|Moscato|Merlot'
cocktailpattern <- 'Ciroc|Avion Margarita|Toddy|Disaronno|Loyal|Mojito|Bloody Mary|Apple of my Rye|Raspberry Lime Ricky|Bourbon Cider|[Mm]argarita'
...
write_xlsx(final_df, 'metLifeCategorized3.csv')  
